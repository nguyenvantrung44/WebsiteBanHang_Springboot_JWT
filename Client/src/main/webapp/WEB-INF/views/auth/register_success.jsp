					...
					<div class="heade_menunav">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<ul class="breadcrumb">
											...
											<li><strong><span>Đăng ký tài khoản thành công</span></strong></li>
						...
						<div class="container margin-bottom-20">
							<div
								...
								<h1 class="title_base_cus text-center">SUCCESSFULLY !!!</h1>
								<h3 style="color: green">Bạn đã đăng ký thành công tài khoản !!!</h3>
								<p style="color: red"><strong>Vui lòng kiểm tra email và kích hoạt tài khoản của bạn. Xin cảm ơn !!!</strong></p>
							</div>
						</div>
