	...
	<div class="row">
		<div class="col-xl-3 col-lg-2 col-md-12 col-sm-12 col-xs-12">
			<div class="logo">
				<a href="/home/trangchu"
					style="display: block; line-height: 100px; height: 100px;"> 
					...
					<div class="col-lg-6">
						...
						<div class="text" id="text-vanchuyen">
							<p style="color: #66a182; font-size: 16px;">Miễn phí vận
								chuyển</p>
							<span style="font-size: 14px;">Với đơn hàng trị giá trên <strong>15.000.000</strong>
							</span>
						</div>
					</div>
					<div class="col-lg-6">
		...
		<div class="col-xl-2 col-lg-2 hidden-md hiden-sm hidden-xs"
			...
			<div class="cart visible-xl visible-lg hidden-md hidden-sm hidden-xs">
				<a href="/nhom3/home/giohang" id="icon-cart"> <img src="../resources/images/icon-cart.png"
					style="padding-top: 12px;">
				</a>
				<div class="text-giohang">
					<a href="/home/showCart" style="font-size: 16px; color: #66a182;">Giỏ
						hàng</a>
